...
return (
  ...
  <svg
    ...
    >
      ...
      <path
        fill="transparent"
        d="M42.884 21.022c.161-3.45 3.165-5.965 10.25-7.187v4.875l9.625-6.938-9.625-6.937v5c-12.008 1.73-15.677 6.558-15.938 11.562 2.84-.18 3.354-.191 5.688-.375z"
      ></path>
    </svg>
  );
}
   ...
   export default AlteServiciiSVG