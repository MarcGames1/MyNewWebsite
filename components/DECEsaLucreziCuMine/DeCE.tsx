...
const creativitate = new DeCEClass('Creativitate', 'Creem impreuna: ideile tale si conceptul si experienta mea. Vei avea parte de expertiza profesionala in creeare de site web, astfel incat tu sa ai cele mai bune optiuni pentru proiectul tau.',<CreativitateSVG height={100} color={svgColor} />)
